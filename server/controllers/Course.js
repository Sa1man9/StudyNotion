...
exports.createCourse = async (req,res) =>{
    try {
        ...
        const instructorDeatails = await User.findById(userId);

        console.log("instructorDetails",instructorDeatails)
...
exports.showAllCourses = async(req, res) =>{
    try {
        ...
        res.status(200).json({
            success:true,
            message:"Data for all courses fectched successfullY",
            data:allCourses
        }) 
...
exports.getInstructorCourses = async (req, res) => {
	try {
        console.log("inside getinstrucCourse")
