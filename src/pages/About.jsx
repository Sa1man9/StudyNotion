    ...
    <div className='mx-auto text-white'>
      ...
      <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            <header className='mx-auto py-20 text-4xl font font-semibold lg:w-[70%]'>
      ...
      <section className='mx-auto p-2 flex flex-col items-center justify-between gap-5 mb-[140px] w-11/12'>
        <LearningGrid/>
        <ContactFormSection />
      </section>
