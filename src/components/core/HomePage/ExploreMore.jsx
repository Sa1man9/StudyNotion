...
const ExploreMore = () => {
  ...
  return (
    <div className=''>
      ...
      <div className='mt-5 flex flex-row rounded-full bg-richblack-800 mb-3 border-richblack-100 px-1 py-1'>
        {
            tabsName.map((element, index)=>{
                return (
                    <div className={`text-[13px] lg:text-[16px] flex flex-row items-center gap-2
      ...
      <div className='flex gap-9 w-full justify-center mt-20 flex-wrap lg:absolute right-0 left-0 mr-auto ml-auto'>
        {
